            ...
            <div class="col secondaryTextColor">
                ...
                <div class="mt-5 mb-1">
                    <a target="blank" href="https://drive.google.com/file/d/1fSiyMIF6nSyi9HfOCtUP30_IXtATHCSx/view">
                        <button class="btn homeButtons">
                            WHAT YOU NEED TO KNOW ABOUT GETTING THE LOWEST <i class="fa-solid fa-circle-arrow-down"></i>
                            RATES
                        </button>
                    </a>
                </div>
                ...
                <div class="mt-3 w-75">
                    <a href="https://api.leadconnectorhq.com/widget/survey/RMsaXDyVPDugQIKojmqf">
                        <img src="../../images/ratesImages/img5.png" class="d-block w-100 ms-auto me-auto" alt="...">
                    </a>
                    ...
                    <a href="https://api.leadconnectorhq.com/widget/survey/RMsaXDyVPDugQIKojmqf">
                        <img src="../../images/ratesImages/img6.png" class="d-block mt-1 w-100 ms-auto me-auto" alt="...">
                    </a>
                </div>
            </div>
            <div class="col secondaryTextColor">
                ...
                <div style="width: 450px" class="ms-1 ms-auto me-auto">
                    ...
                    <p class="lead text-start mt-2">
                        ...
                        mortgage rates shown here. Receipt of the borrower’s application does not represent an approval for
                        financing or interest rate guarantee. Restrictions may apply; Annual APR is subject to approval and
                        underwriting, APR includes all fees and rates calculated on a yearly term. APR varies. Contact us
                        for current rates or more information on a specific product. OAC* Mortgage rates constantly change;
                ...
                <div class="m-1">
                    ...
                    <p>
                        <button class="btn mt-3 btn-dark w-100" type="button" data-bs-toggle="collapse"
                            style="font-size: 17px" data-bs-target="#mortgageRatesCollapsableContent" aria-expanded="false"
                            aria-controls="mortgageRatesCollapsableContent">
                    ...
                    <div class="collapse" id="mortgageRatesCollapsableContent">
                        <div class="card card-body lead">
                            When mortgage rates change, it can happen quite quickly. So when it comes to mortgage, timing is
                            everything. Be sure to secure your mortgage rate while rates are favorable to get the best deal
                            possible. Also, if you are looking to buy a home or you are thinking about changing from your
                            ...
                            <br>
                            <br>
                            Remember, all mortgages aren’t created equal, so it’s important to compare mortgage rates and
                            with a mortgage broker or mortgage agent that you trust. The terms and conditions of mortgages
            ...
            <div class="col secondaryTextColor">
                <div>
                    ...
                    <div class="collapse" id="whatIsOpenMortgageCollapsableContent">
                        <div class="card card-body lead">
                            An “open-term mortgage” is an appealing option to those who plan on paying off their mortgage
                            sooner rather than later. This type of mortgage can be repaid fully or partially at any time
                            without prepayment interest fees. If you want to convert them to another term, you can do so at
                            anytime again without prepayment interest fees. The interest rates for open mortgages tend to be
                            higher than those of closed mortgages because they have such flexibility and options for you as
                            a client. Keep in mind these types of mortgages may have other fees involved as well, so it is
                ...
                <div>
                    ...
                    <div class="collapse" id="whatIsClosedMortgageCollapsableContent">
                        <div class="card card-body lead">
                            ...
                            their mortgage in the near future. The interest rates for closed term mortgages tend to be lower
                            than that of open mortgages. With closed term mortgages, you’re able to save on interest costs,
                            and hopefully, this will help you to pay your mortgage back faster. Fixed or variable options
                            are available for closed term mortgages, but there’s a restriction on the principal amount that
                            you can pay towards our mortgage each year.
                            <br>
                            <br>
                            If you want to renegotiate your rate, you will need to pay a prepayment charge. Also, you will
                            need to pay this prepayment charge, if you wish to pay off the balance of your mortgage before
                            the end of the term or if you want to prepay more money than your mortgage will allow you to.
                            <br>
                            <br>
                            Also there are some closed mortgages that you are not allowed to pay off the mortgage at all
                            until end of term which can make it hard to do refinancing in the future, again these are common
                            terms that can cost thousand of dollars in the future and it is best to ask one of our mortgage
                ...
                <div>
                    ...
                    <div class="collapse" id="prepaymentChargesCollapsableContent">
                        <div class="card card-body lead">
                            With prepayment charges, you have the flexibility to increase your monthly payments or to pay
                            the whole thing off. Contact our team of mortgage agents to find out more about your prepayment
                            options.
            ...
            <div class="col">
                <div class="m-1">
                    ...
                    <p class="lead text-start">
                        More than 50% of Canadians have fixed mortgage rates, which means the monthly payment stays the same
                        over the full term. You are protected against fluctuating interest rates so that it can set up, and
                        you
                        don’t have to worry about it. This may be the best option for you if you want stability, but we have
                        to
            ...
            <div class="col">
                <div class="m-1">
                    ...
                    <p class="lead text-start">
                        ...
                        payments will be based on market behavior, and this will affect how much you are paying. The amount
                        you
        ...
        <div class="mt-5 secondaryTextColor">
            ...
            <div class="my-5">
                ...
                <a target="blank" href="https://app.canadianmortgageapp.com/app/citadelmortgages">
                    <img src="../../images/ratesImages/img7.png" class="d-block mt-1 w-75 ms-auto me-auto" alt="...">
                </a>
            </div>
        </div>
    </section>
    ...
    <section class="container text-center" style="margin-top: 10%">
        ...
        <div class="w-75 ms-auto me-auto secondaryTextColor">
            <div>
                <p>
                    <button class="btn mt-3 btn-dark w-100" type="button" data-bs-toggle="collapse" style="font-size: 17px"
                        data-bs-target="#FAQ_1_CollapsableContent" aria-expanded="false"
                ...
                <div class="collapse" id="FAQ_1_CollapsableContent">
                    <div class="card card-body lead">
                        ...
                        While
                        the actual mortgage payment will still be paid at the contract rate, a higher calculation will be
                        used
            ...
            <div>
                <p>
                    <button class="btn mt-3 btn-dark w-100" type="button" data-bs-toggle="collapse" style="font-size: 17px"
                        data-bs-target="#FAQ_2_CollapsableContent" aria-expanded="false"
                ...
                <div class="collapse" id="FAQ_2_CollapsableContent">
                    <div class="card card-body lead">
                        Yes, home owners will still have the ability to refinance up to 80% of the value of their property.
                        You
            ...
            <div>
                <p>
                    <button class="btn mt-3 btn-dark w-100" type="button" data-bs-toggle="collapse" style="font-size: 17px"
                        data-bs-target="#FAQ_3_CollapsableContent" aria-expanded="false"
                ...
                <div class="collapse" id="FAQ_3_CollapsableContent">
                    <div class="card card-body lead">
                        Mortgage lenders (excluding credit unions and private lenders) are prohibited from arranging with
                        another lender: a mortgage, or a combination of a mortgage and other lending products, in any form
                        that
                        circumvents the institution’s maximum LTV ratio or other limits in its residential mortgage
                        underwriting
                        policy, or any requirements established by law. This is often referred to as “bundling” or “bundle
                        partnership.”
                    </div>
                </div>
            </div>
            <div>
                <p>
                    <button class="btn mt-3 btn-dark w-100" type="button" data-bs-toggle="collapse" style="font-size: 17px"
                        data-bs-target="#FAQ_4_CollapsableContent" aria-expanded="false"
                ...
                <div class="collapse" id="FAQ_4_CollapsableContent">
                    <div class="card card-body lead">
                        For example, a client applies for a mortgage with an 80% LTV, and the lender can only approve 65%.
                        The
                        lender then partners with a second lender for the additional 15%. The original lender then “bundles”
                        the
                        15% LTV mortgage with the initial 65% mortgage to form the complete 80% LTV loan. This is no longer
