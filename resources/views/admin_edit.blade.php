            ...
            <div class="overflow-auto row justify-content-center">
                <div class="col-md-8">
                    <div class=" secondaryTextColor">
                        <h1 class=" text-center">{{ 'Edit Admin Settings' }}</h1>
                        <hr>
                        <div class="card-body">
                            <div class="container">
                                <form method="post" action="{{ route('updateDataOfAdminSetting') }}"
                                    ...
                                    <div class="form-group">
                                        <label for="">Id</label>
                                        <input type="text" readonly class="form-control" name="id_OfAdminSetting"
                                            id="id_OfAdminSetting" value="{{ $adminSettingData[0]->id }}"
                                            aria-describedby="helpId">
                                    </div>
                                    <div class="form-group">
                                        <label for="">User Id</label>
                                        <input type="text" readonly class="form-control" name="userId_OfAdminSetting"
                                            id="userId_OfAdminSetting" value="{{ $adminSettingData[0]->user_id }}"
                                            aria-describedby="helpId">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Master Admin Id</label>
                                        <input type="text" readonly class="form-control"
                                            name="masterAdminid_OfAdminSetting" id="masterAdminid_OfAdminSetting"
                                            value="{{ $adminSettingData[0]->master_admin_id }}" aria-describedby="helpId">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Email</label>
                                        <input type="text" readonly class="form-control" name="email_OfAdminSetting"
                                            id="email_OfAdminSetting" value="{{ $adminSettingData[0]->email }}"
                                            aria-describedby="helpId">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Name</label>
                                        <input type="text" class="form-control" name="name_OfAdminSetting"
                                            id="name_OfAdminSetting" value="{{ $adminSettingData[0]->name }}"
                                            aria-describedby="helpId">
                                    </div>
                                    <div class="form-group">
                                        <label for="">Company Name</label>
                                        <input type="text" class="form-control" name="companyName_OfAdminSetting"
                                            id="companyName_OfAdminSetting"
                                            value="{{ $adminSettingData[0]->company_name }}" aria-describedby="helpId">
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-2">
                                                <input type="color" class="border-0"
                                                    ...
                                                    value="{{ $adminSettingData[0]->primary_color }}"
                                                    style="width: 100%; height: 100%;" title="Choose your color">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-10">
                                                <input type="text" class="form-control"
                                                    name="secondaryColorOfAdminSetting" id="secondaryColorOfAdminSetting"
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <div class="row">
                                            <div class="col-10">
                                                <input type="text" class="form-control"
                                                    name="tertiaryColorOfAdminSetting" id="tertiaryColorOfAdminSetting"
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <div class="row">
                                                <div class="col-10">
                                                    <input type="text" class="form-control"
                                                        name="primaryTextColorOfAdminSetting"
                                                        id="primaryTextColorOfAdminSetting"
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <div class="row">
                                                <div class="col-10">
                                                    <input type="text" class="form-control"
                                                        name="secondaryTextColorOfAdminSetting"
                                                        id="secondaryTextColorOfAdminSetting"
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <div class="row">
                                                <div class="col-10">
                                                    <input type="text" class="form-control"
                                                        name="tertiaryTextColorOfAdminSetting"
                                                        id="tertiaryTextColorOfAdminSetting"
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <div class="row">
                                                <div class="col-10">
                                                    <input type="text" class="form-control"
                                                        name="fourthTextColorOfAdminSetting"
                                                        id="fourthTextColorOfAdminSetting"
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <p><label class="btn btn-primary" for="file"
                                                    style="cursor: pointer;">Upload Image
                                                </label>
                                                <input style="border: 0px solid;" readonly type="text"
                                                    name="pathOfImage" value="{{ $adminSettingData[0]->logo }}"
                                                    id="pathOfImage">
                                            </p>
