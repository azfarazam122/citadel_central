            ...
            <div class="row justify-content-center">
                <div class="col-md-8">
                    <div class="card secondaryTextColor">
                         <h1 class="card-header text-center">{{('Admin Settings') }}</h1>
                        <div class="card-body">
                            <div class="container">
                                <form method="">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly class="form-control" name="name_OfAdminSetting" id="name_OfAdminSetting"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-10">
                                                <input type="text" readonly  class="form-control" name="primaryColorOfAdminSetting"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-10">
                                            <input type="text" readonly class="form-control" name="secondaryColorOfAdminSetting"
                                    ...
                                    <div class="form-group mt-3">
                                        <label for="">Tertiary Color</label>
                                          <div class="row">
                                            <div class="col-10">
                                            <input type="text" readonly class="form-control" name="tertiaryColorOfAdminSetting"
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <div class="row">
                                            <div class="col-10">
                                                <input type="text" readonly class="form-control" name="primaryTextColorOfAdminSetting"
                                    ...
                                    <div class="form-group mt-3">
                                        <label for="">Secondary Text Color</label>
                                            ...
                                            <div class="row">
                                                <div class="col-10">
                                                    <input type="text" readonly class="form-control" name="secondaryTextColorOfAdminSetting"
                                    ...
                                    <div class="form-group mt-3">
                                        <label for="">Tertiary Text Color</label>
                                            <div class="row">
                                                <div class="col-10">
                                                    <input type="text" readonly class="form-control" name="tertiaryTextColorOfAdminSetting"
                                    ...
                                    <div class="form-group mt-3">
                                        <label for="">Fourth Text Color</label>
                                            <div class="row">
                                                <div class="col-10">
                                                    <input type="text" readonly class="form-control" name="fourthTextColorOfAdminSetting"
