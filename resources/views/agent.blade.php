                        ...
                        <div class="card-body">
                            <div class="container">
                                <form method="post" action="{{ route('updateDataForAgentLogin') }}">
                                    ...
                                    <h3>Edit <span class="text-capitalize text-decoration-underline">
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <p><label class="btn btn-primary" for="file" style="cursor: pointer;">Upload Image
                                            </label> <span name="pathOfImage" id="pathOfImage">
                                                {{ $agentData[0]->profile_pic }}</span> </p>
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" class="form-control"
                                            ...
                                            value={{ $agentData[0]->about_us_apply_now_link }} aria-describedby="helpId"
                                            placeholder="">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a class="mt-3 btn btn-primary" href="/admin_dashboard">Back</a>
                                    </div>
                                </form>
                            </div>
                        </div>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            image.src = "../images/profile_pic/" + path;
