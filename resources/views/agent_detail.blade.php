            ...
            <div class="row overflow-auto justify-content-center">
                <div class="col-md-8">
                    <div class=" secondaryTextColor">
                        <h1 class="fw-bold text-center">Agent {{ $agentData[0]->full_name }}
                        </h1>
                        <hr>
                        <div class="card-body">
                            <div class="container">
                                <form method="post" action="{{ route('updateDataForAgentLogin') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" readonly class="form-control" name="editNameOfAgent"
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" readonly class="form-control" name="editPhoneOfAgent"
                                            id="editPhoneOfAgent" value="{{ $agentData[0]->phone }}"
                                            aria-describedby="helpId" placeholder="">
                                    </div>
                                    <div class="form-group mt-3">
                                        <label for="">Facebook Link</label>
                                        <input type="text" readonly class="form-control" name="editFacebookLinkOfAgent"
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" readonly class="form-control" name="editInstagramLinkOfAgent"
                                            id="editInstagramLinkOfAgent" value="{{ $agentData[0]->instagram_link }}"
                                            aria-describedby="helpId" placeholder="">
                                    </div>
                                    <div class="form-group mt-3">
                                        <label for="">Twitter Link</label>
                                        <input type="text" readonly class="form-control" name="editTwitterLinkOfAgent"
                                    ...
                                    <div class="form-group mt-3">
                                        ...
                                        <input type="text" readonly class="form-control"
                                            name="editAboutPageBioLinkOfAgent" id="editAboutPageBioLinkOfAgent"
