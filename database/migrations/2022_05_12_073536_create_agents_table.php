...
class CreateAgentsTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('agents', function (Blueprint $table) {
            ...
            $table->string('how_to_collect_your_miles_today_link')->default('');
            $table->string('your_financial_journey_link')->default('');
            $table->string('mortgage_prequalification_link')->default('');
            $table->string('your_home_journey_link')->default('');
            $table->string('your_mortgage_calculators_link')->default('');
            $table->string('calculate_how_you_can_be_mortgagefreesooner_link')->default('');
            $table->string('get_prequalified_now_link')->default('');
            $table->string('bio_apply_now_link')->default('');
            $table->string('apply_now_link')->default('');
            $table->string('about_us_apply_now_link')->default('');
